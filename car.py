# -*- coding: utf-8 -*-
"""AIML_NIT_PROJEC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QXLLrOJws0v2Eyplv_QqEygLIj0JCwUQ
"""
...
train_data = pd.read_csv("/content/Project_train-data.csv")
test_data = pd.read_csv("/content/Project_test-data.csv")
...
# Option 2: Convert non-numeric columns to categorical
...
x_labels = ['Random Forest', 'Linear Regression']
y_train = [rf_train_acc, lr_train_acc]
y_test = [rf_test_acc, lr_test_acc]

ax1.bar(x_labels, y_train, color=['blue', 'orange'])
ax1.set_title('Training Accuracy')
ax1.set_ylabel('Accuracy (%)')

ax2.bar(x_labels, y_test, color=['blue', 'orange'])
